    ...
    {response && (
      <div>
        <div className="business-response-item">
          ...
          <div>
            {response?.monthlyBusiness?.totalRevenue ?? 0}
          </div>
        </div>
    ...
    {response && (
      <div>
        <div className="business-response-item">
          <div>Total Business: ₹</div>
          <div>
            {response?.dailyBusiness?.totalRevenue ?? 0}
          </div>
        </div>
  ...
  <form className="modal-form">
    ...
    {response?.yearlyBusiness && (
      <div>
        <div className="business-response-item">
          <div>Total Business: ₹</div>
          <div>{response.yearlyBusiness.totalRevenue}</div>
        </div>
        ...
        {Object.keys(response.yearlyBusiness.categorySales || {}).length === 0 && (
    ...
    {response && (
      <div>
        <div className="business-response-item">
          <div>Total Business: ₹</div>
          <div>
            {response?.overallBusiness?.totalRevenue ?? 0}
          </div>
        </div>
